    ...
    <div class="container mt-5 d-flex justify-content-center">
        ...
        <div class="card p-3">
            <div class="d-flex flex-row align-items-center justify-content-between text-white">
                <div class="d-flex flex-row align-items-center"> <i class="fa fa-angle-left"></i> <span class="ml-2">Lipa na Mpesa</span> </div>
            ...
            <div class="mt-5 align-items-center d-flex justify-content-center"> <small class="text-white">Please pay to continue</small> </div>
